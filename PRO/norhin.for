...
c  2019 ?????? Jh: new format 
c  20210302    jh: also write out ain and az, component, distane and 
c                  data source                                                                         
c
c
      implicit none
...
c
            ...
            text(92:94)=data(k)(77:79)
c
c   distance
c
            text(74:78)=data(k)(71:75)   
c
c   angles
c
            text(79:81)=data(k)(58:60)
            text(92:94)=data(k)(77:79)
             
c
c  component in available fields
c
            text(9:9)=data(k)(8:8)
            text(10:12)=data(k)(7:7)//'H'//data(k)(8:8)
c
c   data source
c
            text(109:109)='2'    
