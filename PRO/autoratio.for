...
c    19 mar 2019 jh: new format
c    11 oct 2019 jh: bug if sample rate 0.0
c    
...
cxx
c          write(6,*) 'start',k,wav_out_start(k)
...
c
c   skip if error with sample rate or data, jh oct 2023
c
            if(fsmax.eq.0.0) then
               write(6,*)'Error with data, sample rate 0.0, skip chan'
               goto 500
            endif
