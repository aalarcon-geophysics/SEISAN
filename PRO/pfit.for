...
c
      ...
      k=k-1
c   ZJ I think py and px are interchanged if we compare 
c   to text book and equations 
...
c
     ...
     *    '   corr=',corr
c   ZJ changed the xtext from  xtext=' (x-coordinate)/(y-coordinate)'  to  
c                              xtext=' (y-coordinate)/(x-coordinate)'
          xtext=' (y-coordinate)/(x-coordinate)'
...
c   plot points
c
c   ZJ commented the x(1)=3  (???)
c          x(1)=3     ! points in red
          call xy_plot
