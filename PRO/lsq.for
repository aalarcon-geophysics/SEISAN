...
c
      ...
      real avx,sdx,avy,sdy                ! average and sd of x and y
      character*1 answer 
...
c   calculate average
c
      call sdv(n,x,avx,sdx)
      call sdv(n,y,avy,sdy)
      write(6,*)
      write(6,*) 'Average  with sd of x and y', avx,sdx,avy,sdy
      write(6,*)
c
c   get options
c
      write(6,*)'Option  1: line fit'
      write(6,*)'        2: make a curve or just points'
...
C***********************************************************************
C                                                                    
      SUBROUTINE xLSQLIN(N,X,Y,A,B,CORR,RMS)                               
C                                                                       
