...
c
c   changes
c   apr 7  2019 jh: new format, add get_seisan_def
c   sep 21 2020 jh: hash to hash_seisan
c   
c
c
c
...
c
              ...
              open(77,file='hash_seisan.out',status='old',err=55)
c
