...
c  dec 10 20 jh. eliminate H lines since now read automaticlaly by hyp
c                no crash if depth reange is real
c
...
c   get depth range
c
      write(6,*)'Depth range to use, will be rounded off to integers ?'
      read(5,*) x,y
      mindep=x
      maxdep=y
