...
c 2019 31 01 jh   : new nordic format
c 2019 12 17 jh   : allow reading to end of s-file if blank line
c 2020 11 19 jh   : default end time 2025
C
      implicit none
      include 'seidim.inc'
      include 'rea.inc'
...
c
       ...
       if(base_name(1:2).eq.',,') then                                              
           ...
           write(6,'(1x,a,$)')' End time,  enter for 2025        : '                           
           read(5,'(a14)') end_time
           if(end_time.eq.' ') end_time='2025        '
       else     
