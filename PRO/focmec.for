...
c 2019 02 21 jh: new format
c 2020 01 20 jh: increase dimension in stermec for strike, dip and rake
c
C----------------------------------------------------------------
C
...
135     continue
     ...
     *     ', enter for 1.0' 
           ...
           relweight='n'
           write(*,'(a)') 
     *     ' Maximum number of allowed polarity errors, enter for 0' ! lo def is 0
        endif
        read(*,'(a)') text                       ! Get reply.
        if(text.eq.' ') text(1:3)='0.0'
...
c     1     RAKE(200),  rcircle
      REAL ANBTP(6),ANGS(3),ANGS2(3),PTTP(4),DIP(5000),STRIKE(5000),
     1     RAKE(5000),rcircle
...
c
      ...
      if(new_nordic_format) then
         call get_sense_new(data(i),sense,0)
      else
      ...
      if (sense.ne.' ') then
         if(new_nordic_format) then
            if(data(i)(59:63).ne.'   '.and.data(i)(77:79).ne.'   ') 
     *      then
               npol=npol+1
               pol(npol)=sense   ! lot 21.01.2002
               read(data(i)(59:63),'(f5.1)') ain(npol)
...
c dilatation
     ...
     &         option.eq.1) then
      ...
      subroutine get_sense_new(text,sense,option)
c
c return sense as defined in original version of focmec
c Lars Ottemoller, 21.01.2002
c
...
c
      ...
      sense=' '
c compression
      if (text(44:44).eq.'C'.or.text(44:44).eq.'U') then
        if (text(17:17).eq.'P') then
          if (text(16:16).eq.'I'.or.
     &        text(16:16).eq.' '.or.
     &        option.eq.1) then
            sense='C'
          elseif (text(16:16).eq.'E') then
             sense='+'
          endif
        endif   ! P
           
c dilatation
      elseif (text(44:44).eq.'D') then
        if (text(17:17).eq.'P') then
          if (text(16:16).eq.'I'.or.
     &         text(16:16).eq.' '.or.
     &         option.eq.1) then
      ...
      elseif (text(44:44).eq.'V') then            ! fix new ok ?
        sense='V'
      elseif (text(44:44).eq.'S') then
        sense='S'
      elseif (text(44:44).eq.'H') then
        sense='H'
      endif
      return
      end
...
c flag 
      ...
      real xx
c
c   define here because seisan.inc has some variable also used here but with 
c   different meaning like qalpha_p
c
      logical new_nordic_format,dummy
      common/new_nordic/new_nordic_format,dummy
...
c
         if(data(i)(58:79).ne.' ') then
           if(new_nordic_format) then
              call get_sense_new(data(i),sense,1)                    ! fix polarity notation
           else
              call get_sense(data(i),sense,1)
           endif 
             if (sense.ne.' ') then
...
c
               if(new_nordic_format) then
                  read(data(i)(17:18),'(a2)')   phasenm
                  read(data(i)(59:63),'(f5.1)') anginc
               else
...
c
     ...
     *            data(i)(2:5),az,anginc,sense,data(i)(17:22)
               else
                  write(write3,'(a4,2f8.2,a1,25x,a)')         ! focmec 2017, 17x to 25x 
...
c
               if(new_nordic_format) then
                  k=anginc
                  write(write2,'(a5,1x,a3,1x,i3,1x,a1)')
     &            data(i)(2:6),data(i)(77:79),
     &            k,data(i)(44:44)                            ! fix new check if others 
               else
...
c
      ...
      do i=nhead+1,nrecord-1
         if(new_nordic_format) then
            if((data(i)(17:20).eq.'AMSG'.or.data(i)(17:20).eq.'AMPN').
     *      and.data(i)(25:25).ne.'4') 
     *      amp_manual=amp_manual+1
            if((data(i)(17:20).eq.'ATPG'.or.data(i)(17:20).eq.'ATSG').
     *       and.data(i)(25:25).ne.'4') 
     *       amp_auto=amp_auto+1
            if((data(i)(17:20).eq.'ASPG'.or.data(i)(17:20).eq.'ASSG'). 
     *       and.data(i)(25:25).ne.'4')
...
c----------
      ...
      do i=nhead+1,nrecord-1
         ...
         if (((data(i)(17:20).eq.'AMPG'.or.data(i)(17:20).eq.'AMPN'.or.
     *   data(i)(17:20).eq.'AMSG'.or.data(i)(17:20).eq.'AMSN'.or.
     *   data(i)(17:20).eq.'ATPG'.or.data(i)(17:20).eq.'ASPG'.or.
     *   data(i)(17:20).eq.'ATSG'.or.data(i)(17:20).eq.'ASSG')
     *   .and.
     *   (data(i)(9:9).eq.'Z'.or.data(i)(9:9).eq.'R'  ! make sure correct component
     *   .or.data(i)(9:9).eq.'T')
     *   .and.data(i)(24:24).ne.'4'  ! do not use if weighted out
     *   .and.new_nordic_format)

     *   .or.

     *   ((data(i)(11:14).eq.'AMPG'.or.data(i)(11:14).eq.'AMPN'.or.
     *   data(i)(11:14).eq.'AMSG'.or.data(i)(11:14).eq.'AMSN'.or.
     *   data(i)(11:14).eq.'ATPG'.or.data(i)(11:14).eq.'ASPG'.or.
     *   data(i)(11:14).eq.'ATSG'.or.data(i)(11:14).eq.'ASSG')
     *   .and.
     *   (data(i)(8:8).eq.'Z'.or.data(i)(8:8).eq.'R'.  ! make sure correct component
     *   or.data(i)(8:8).eq.'T')
     *   .and.data(i)(15:15).ne.'4'  ! do not use if weighted out
     *   .and..not.new_nordic_format)) then
...
c
            if(amp_type.eq.1.and.data(i)(17:18).ne.'AM') goto 1200
            if(amp_type.eq.2.and.data(i)(17:18).ne.'AT') goto 1200
            if(amp_type.eq.3.and.data(i)(17:18).ne.'AS') goto 1200
...
c
            ...
            read(data(i)(38:50),'(g7.1,f6.1)') amp_amp(namp),
     *      amp_per(namp)
c
...
c
     ...
     *         then
            ...
            do k=nhead+1,nrecord
               if(amp_stat(namp).eq.data(k)(2:5).and.              ! station
     *         (data(k)(17:18).eq.'PN'.or.data(k)(17:18).eq.'P ')) 
     *         then
                  read(data(k)(59:63),'(f5.1)') amp_anginc(namp)
                  goto 1111
                endif
             enddo
           endif
