...
C
c
c sort CSEIS into LOSEIS, in the CCSQRT routine cseis gets put into 2dim real array
              do j=1,nt
                loseis(1,j)=real(cseis(j))
                loseis(2,j)=aimag(cseis(j))
              enddo

c230           CALL CCSQRT (CSEIS,NT,SEIS)
230           CALL CCSQRT (LOSEIS,NT,SEIS)
C
