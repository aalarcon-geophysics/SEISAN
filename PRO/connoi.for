...
c        cont_interval=(duration_min+15.)*60. ! changed back, lo 28/5/2014
        cont_interval=(duration_min*1.05)*60. ! changed  lo 22/5/2019
...
c          cwav_abs_end_time=cwav_abs_start_time+(duration_min+15.)*60.	! lo
          cwav_abs_end_time=cwav_abs_start_time+(duration_min*1.05)*60.	! lo
          if (skip) goto 99
          if (arc) then
