...
// common resolution and aspect ratio
// 4x3  -> 1.33
// 1024x768
// 
// 16x9 -> 1.77
...
// lo april 2020
  ...
  aspect = nxpix / nypix;
//  printf("debug lo nxpix %d %d\n",nxpix,nypix);
  if ( aspect > 1.8 && nxpix>2000 )
  {
    nxpix=nxpix/1.8;    
//    printf("debug lo changing nxpix %d\n",nxpix);
  }
